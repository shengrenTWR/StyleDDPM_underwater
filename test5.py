...
data = torchvision.datasets.StanfordCars(root="./", download=True) # this can be solved by https://github.com/pytorch/vision/issues/7545
data=torchvision.datasets.ImageFolder('source')
show_images(data)
...
def load_transformed_dataset():
    ...
    train_data=torchvision.datasets.ImageFolder('source',transform=data_transform)
    return train_data
...
@torch.no_grad()
def sample_plot_image(epochs, T, IMG_SIZE):
    # Sample noise
    img_size = IMG_SIZE
    ...
    plt.show()
    plt.savefig("logs/sample_plot_image_"+"IMG_SIZE_"+str(IMG_SIZE)+"_epochs_"+str(epochs)+"_T_"+str(T)+".png") 
...
for epoch in range(epochs):
    for step, batch in enumerate(dataloader):
      ...
      if epoch % 5 == 0 and step == 0:
        ...
        sample_plot_image(epochs, T, IMG_SIZE)
        
        
save_dir = 'models/model.pt'   #保存路径
