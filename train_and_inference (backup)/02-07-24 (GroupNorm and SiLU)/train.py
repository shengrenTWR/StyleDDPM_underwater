...
ImageF = 'target'
# Save model's name
save_dir = 'models/model_paper8.pt' 
save_dir2 = 'models/model2_paper8.pt' 
...
def sample_plot_image(epochs, T, IMG_SIZE, model, x_0, model2, save_fig_name):
    ...
    plt.show()
    plt.savefig(save_fig_name+"_y_0_paper8"+"IMG_SIZE_"+str(IMG_SIZE)+"_epochs_"+str(epochs)+"_T_"+str(T)+".png") 
    show_tensor_image(img.detach().cpu())
    plt.show()
    plt.savefig(save_fig_name+"_x_0_paper8"+"IMG_SIZE_"+str(IMG_SIZE)+"_epochs_"+str(epochs)+"_T_"+str(T)+".png") 
    ...
    for epoch in range(epochs):
        for step, (batch, batch2) in enumerate(zip(dataloader, dataloader2)):   # How to iterate over two dataloaders simultaneously?
          ...
          if epoch % 5 == 0 and step == 0:
            ...
            #print(batch[0].shape)
            save_fig_name = "logs2/Model1_sample_plot_image_"
            save_fig_name2 = "logs2/Model2_sample_plot_image_"
