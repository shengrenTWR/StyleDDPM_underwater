...
ImageF = 'target'
# Save model's name
save_dir = 'models/model_paper6.pt' 
save_dir2 = 'models/model2_paper6.pt' 
...
def sample_plot_image(epochs, T, IMG_SIZE, model, x_0, model2, save_fig_name):
    ...
    plt.show()
    plt.savefig(save_fig_name+"_y_0_paper6"+"IMG_SIZE_"+str(IMG_SIZE)+"_epochs_"+str(epochs)+"_T_"+str(T)+".png") 
    show_tensor_image(img.detach().cpu())
    plt.show()
    plt.savefig(save_fig_name+"_x_0_paper6"+"IMG_SIZE_"+str(IMG_SIZE)+"_epochs_"+str(epochs)+"_T_"+str(T)+".png") 
